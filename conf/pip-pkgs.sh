...
MPICC="mpicc" pip install --no-cache-dir --no-binary=:all: git+https://github.com/adematti/pmesh
...
pip install --no-cache-dir --no-deps healpy camb emcee schwimmbad getdist dynesty dill
